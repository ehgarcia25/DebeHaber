...
@section('title', 'Empresa | DebeHaber')
    ...
    <div class="row">
        <div class="col-md-3 profile-image">
            <div class="profile-image-container">
                <img src="assets/images/CognitivoLogo.png" alt="">
            </div>
        </div>
...
<div id="main-wrapper">
    <div class="row">
        <div class="col-md-3 user-profile">
            <h3 class="text-center">Cognitivo Paraguay</h3>
            <p class="text-center">Desarrollo de Software</p>
            <hr>
            <ul class="list-unstyled text-center">
                <li><p><i class="fa fa-map-marker m-r-xs"></i>Asunción, Paraguay</p></li>
                <li><p><i class="fa fa-envelope m-r-xs"></i><a href="#">hola@cognitivo.in</a></p></li>
                <li><p><i class="fa fa-link m-r-xs"></i><a href="#">www.cognitivo.in</a></p></li>
            </ul>
            <hr>
