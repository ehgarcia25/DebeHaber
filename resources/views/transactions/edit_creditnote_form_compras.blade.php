...
@section('title', 'Actualizar Notas de Crédito Compras | DebeHaber')
...
{{--<form class="form-horizontal" action="{{url('save_credito_compras')}}" method="POST" id="form_credit_compras" name="form_credit_compras">--}}
    ...
    {!! Form::model($nota_credito,array('url'=> 'update_credit_compras', 'method'=> 'post','class'=>'form-horizontal','id'=>'form_credit_compras','name'=>'Form')) !!}
=======
<div ng-app="formApp">
