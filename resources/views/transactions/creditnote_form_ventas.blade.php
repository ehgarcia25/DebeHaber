...
@section('title', 'Notas de Crédito Ventas | DebeHaber')
@section('Title', 'Registro Notas de Crédito Ventas')
...
@section('content')
    ...
    <div ng-app="formApp">
        <div ng-controller="MainCtrl">
            ...
            {!! Form::open(array('url'=> 'save_credito_ventas', 'method'=> 'post','class'=>'form-horizontal', 'id'=>'form_credit_compras', 'name'=>'Form')) !!}
            {!! csrf_field() !!}
