...
@section('Title', 'Registro Notas de Crédito Compras')
...
{{--<form class="form-horizontal" action="{{url('save_credito_compras')}}" method="POST" id="form_credit_compras" name="form_credit_compras">--}}
    ...
    {!! Form::open(array('url'=> 'save_credito_compras', 'method'=> 'post','class'=>'form-horizontal', 'id'=>'form_credit_compras')) !!}
    {!! csrf_field() !!}
...
{{--<form class="form-horizontal" action="{{url('save_credito_compras')}}" method="POST" id="form_credit_compras" name="form_credit_compras">--}}
    ...
    {!! Form::open(array('url'=> 'save_credito_compras', 'method'=> 'post','class'=>'form-horizontal', 'id'=>'form_credit_compras', 'name'=>'Form')) !!}
    {!! csrf_field() !!}
     {!! Form::hidden('tipo',"Compra",['id'=>'tipo']) !!}
>>>>>>> origin/master
    @include('transactions.partials.fields_notas_credito')
    <div class="col-md-4">
...
<<<<<<< HEAD
            ...
            {!! Form::submit('Aprobar y Guardar',['class'=>'btn btn-success','id'=>'aprobar_compra_guardar']) !!} {{--<button type="submit" class="btn btn-success " id="aprobar_compra" ng-click="submitForm(formData)" ng-disabled="!Form.$valid">Aprobar</button>--}}
=======
            {!! Form::submit('Guardar',['class'=>'btn btn-success','id'=>'guardar_compra', 'ng-click'=>'submitForm(formData)', 'ng-disabled'=>'!Form.$valid']) !!}
            {!! Form::submit('Aprobar y Guardar',['class'=>'btn btn-success','id'=>'aprobar_compra_guardar', 'ng-click'=>'submitForm(formData)', 'ng-disabled'=>'!Form.$valid']) !!} {{--<button type="submit" class="btn btn-success " id="aprobar_compra" ng-click="submitForm(formData)" ng-disabled="!Form.$valid">Aprobar</button>--}}
>>>>>>> origin/master
