...
@section('content')
<a class="btn btn-primary btn-lg" href="credito_form">Crear Nota de Crédito Ventas</a>
<a class="btn btn-primary btn-lg" href="credito_form">Crear Nota de Crédito Compras</a>
