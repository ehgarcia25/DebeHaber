    ...
    <div ng-app="formApp">
        <div ng-controller="MainCtrl">
            <form class="form-horizontal" action="{{url()}}/update_venta" method="post" id="form_save_compras" name="Form">
                ...
                <input type="hidden" name="miventa" value="{{$compra->id}}">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7" id="news">
                            {!!  Form::text('cliente',$micompania->gov_code." ".$micompania->name,['class'=> 'form-control','id'=>'example-ajax-post', 'required','autocomplete'=>'off', 'ng-class'=>'{ error: Form.cliente.$error.required && !Form.$pristine}']) !!}
