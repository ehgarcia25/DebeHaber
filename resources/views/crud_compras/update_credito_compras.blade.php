...
<form class="form-horizontal" action="{{url('update_credit')}}" method="POST" id="form_actualizar_credit_compras">
    ...
    <div class="col-md-8">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <select class="form-control" id="single" onchange="val()" name="proveedor">
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-success" id="actualizar_credito_compras">Actualizar</button>
        </div>
    </div>
</form>
