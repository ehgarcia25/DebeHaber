...
<input type="hidden" name="micobro" value="{{$cobros->id}}">
<div class="col-md-8">

    <div class='form-group'>
        <label for="serie" class="col-sm-3 control-label">Serie:</label>
        <div class="col-sm-7">
            <input type="text" name="serie" class="form-control" value="{{$cobros->series}}" autocomplete="off" required/>
    ...
    <div class='form-group'>
        ...
        <div class="col-sm-7">
            ...
            {!!  Form::text('fecha',$cobros->payment_date,['class'=> 'form-control date-picker', 'id'=>'fecha', 'required','autocomplete'=>'off','data-date-format'=>"yyyy-mm-dd", 'ng-class'=>'{ error: Form.fecha.$error.required && !Form.$pristine}']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7" id="news">
            ...
            <input id="example-ajax-post" name="contribuyente" class="form-control" value="{{$micompania->gov_code." ".$micompania->name}}"/>
    ...
    <div class='form-group'>
        ...
        <div class="col-sm-7">
            <input type="text" name="recibo" class="form-control" value="{{$cobros->payment_number}}" autocomplete="off"  placeholder="" ng-model="formData.recibo" required
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            {!!  Form::select('cuenta',$cuenta,$micuenta[0]->name,['class'=> 'form-control','required']) !!}
    ...
    <div class='form-group'>
        ...
        <div class="col-sm-7">
            <input type="text" name="monto" class="form-control" value="{{$cobros->payment_total}}" autocomplete="off"  placeholder="" ng-model="formData.monto" required
